...
class MySqlGrammar extends sif_1.Grammar {
    ...
    initialize() {
        ...
        this.add("TABLE_NAME", ["TICK", "IDENTIFIER", this.pushValueUp, "TICK"], ["IDENTIFIER", this.pushValueUp,]);
        this.add("COLUMN_NAME", ["TICK", "IDENTIFIER", this.pushValueUp, "TICK"], ["IDENTIFIER", this.pushValueUp]);
        ...
        this.add("CREATE_DEFINITION", ["COLUMN_NAME", this.columnName, "COLUMN_DEFINITION", this.createColumn], ["CONSTRAINT", "CONSTRAINT_OPTIONS"], ["INDEX_OR_KEY", "INDEX_NAME", "INDEX_TYPE", "INDEX_COLUMN_LIST", "INDEX_OPTION"]);
        this.add("INDEX_NAME", ["IDENTIFIER"], ["LAMBDA"]);
        this.add("INDEX_OR_KEY", ["RW_INDEX"], ["RW_KEY"]);
        this.add("CONSTRAINT", ["RW_CONSTRAINT", "STRING"], ["RW_CONSTRAINT"], ["LAMBDA"]);
        this.add("CONSTRAINT_OPTIONS", ["RW_PRIMARY", "RW_KEY", "INDEX_TYPE", "INDEX_COLUMN_LIST", "INDEX_OPTION"], ["RW_UNIQUE", "UNIQUE_CONSTRAINT_OPTIONS"], ["RW_FOREIGN", "RW_KEY", "INDEX_NAME", "INDEX_COLUMN_LIST", "REFERENCE_DEFINITION"]);
        this.add("REFERENCE_DEFINITION", ["RW_REFERENCES", "TABLE_NAME", "INDEX_COLUMN_LIST", "MATCH_TYPE", "ON_DELETE", "ON_UPDATE"]);
        ...
        this.add("UNIQUE_CONSTRAINT_OPTIONS", ["RW_INDEX", "LEFT_PARAN", "IDENTIFER", "RIGHT_PARAN", "INDEX_TYPE", "INDEX_COLUMN_LIST", "INDEX_OPTION"], ["RW_KEY", "INDEX_NAME", "INDEX_TYPE", "INDEX_COLUMN_LIST", "INDEX_OPTION"]);
        this.add("INDEX_TYPE", ["RW_USING", "RW_BTREE"], ["RW_USING", "RW_HASH"], ["LAMBDA"]);
        this.add("INDEX_COLUMN_LIST", ["LEFT_PARAN", "IDENTIFIER", "LENGTH", "DIRECTION", "INDEX_COLUMN_TAIL"], ["LEFT_PARAN", "TICK", "IDENTIFIER", "LENGTH", "DIRECTION", "TICK", "INDEX_COLUMN_TAIL"]);
        this.add("INDEX_COLUMN_TAIL", ["COMMA", "IDENTIFIER", "LENGTH", "DIRECTION", "INDEX_COLUMN_TAIL"], ["COMMA", "TICK", "IDENTIFIER", "LENGTH", "DIRECTION", "TICK", "INDEX_COLUMN_TAIL"], ["RIGHT_PARAN"]);
        this.add("DIRECTION", ["RW_ASC"], ["RW_DESC"], ["LAMBDA"]);
        this.add("INDEX_OPTION", ["KW_KEY_BLOCK_SIZE", "EQUALS", "INTEGER"], ["INDEX_TYPE"], ["RW_WITH", "RW_PARSER", "IDENTIFIER"], ["RW_COMMENT", "STRING"], ["LAMBDA"]);
        this.add("COLUMN_DEFINITION", ["DATA_TYPE", "NULL_TYPE", "DEFAULT_VALUE"]);
        this.add("DATA_TYPE", ["RW_BIT", this.storeType, "LENGTH", "UNSIGNED", "ZEROFILL"], ["RW_BIT", this.storeType], ["TYPE_INT", "LENGTH", "UNSIGNED", "ZEROFILL"], ["TYPE_INT"], ["RW_REAL", this.storeType, "LENGTH", "UNSIGNED", "ZEROFILL"], ["RW_REAL", this.storeType], ["RW_DOUBLE", this.storeType, "LENGTH", "UNSIGNED", "ZEROFILL"], ["RW_DOUBLE", this.storeType], ["RW_FLOAT", this.storeType, "LENGTH", "UNSIGNED", "ZEROFILL"], ["RW_FLOAT", this.storeType], ["RW_DECIMAL", this.storeType, "LENGTH", "UNSIGNED", "ZEROFILL"], ["RW_DECIMAL", this.storeType], ["RW_NUMERIC", this.storeType, "LENGTH", "UNSIGNED", "ZEROFILL"], ["RW_NUMERIC", this.storeType], ["KW_DATE", this.storeType], ["RW_TIME", this.storeType, "LENGTH"], ["RW_TIME", this.storeType], ["RW_TIMESTAMP", this.storeType, "LENGTH"], ["RW_TIMESTAMP", this.storeType], ["RW_YEAR", this.storeType, "LENGTH", "BINARY"], ["RW_CHAR", this.storeType, "LENGTH"], ["RW_CHAR", this.storeType], ["RW_VARCHAR", this.storeType, "LENGTH", "BINARY", "CHARACTER_SET", "COLLATE"], ["RW_VARCHAR", this.storeType, "LENGTH"], // Non-optional length
        ["RW_BINARY", this.storeType, "LENGTH"], ["RW_BINARY", this.storeType], ["RW_VARBINARY", this.storeType, "LENGTH"], // Non-optional length
        ["TYPE_BLOB",], ["TYPE_TEXT", "BINARY", "CHARACTER_SET", "COLLATE"], ["TYPE_TEXT"], ["KW_ENUM", this.storeType, "LEFT_PARAN", "ENUM_STRING_LIST", "RIGHT_PARAN"], ["RW_SET", this.storeType, "LEFT_PARAN", "SET_STRING_LIST", "RIGHT_PARAN"], ["RW_JSON", this.storeType]);
        this.add("BINARY", ["RW_BINARY", (value) => { this.currentType.type.binary = true; }], ["LAMBDA"]);
        this.add("CHARACTER_SET", ["RW_CHARACTER", "RW_SET", "IDENTIFER", (value) => { this.currentType.type.characterSet = value; }], ["LAMBDA"], ["RW_COLLATE", "IDENTIFER", (value) => { this.currentType.type.collate = value; }]);
        ...
        this.add("NULL_TYPE", ["RW_NOT", "RW_NULL"], ["RW_NULL"], ["LAMBDA"]);
        this.add("DEFAULT_VALUE", ["RW_DEFAULT", "EXPRESSION"], ["LAMBDA"]);
        this.add("EXPRESSION", ["RW_NULL"]);
